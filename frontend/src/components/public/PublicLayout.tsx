...
// Format phone number for tel: links — strip non-digits, prepend +1
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="bg-navy-900 text-stone-300 text-xs py-2 px-4 text-center">
        Licensed & Insured · {business.city || 'Orlando'} & Surrounding Areas · Available 24/7 for Calls ·{' '}
        <a href={toTelHref(business.phone)} className="text-wood-400 hover:text-wood-300 font-medium">
        ...
        <div className="max-w-5xl mx-auto relative">
          <div className="bg-white/95 backdrop-blur-md border border-stone-200 rounded-full shadow-md px-5 py-2.5 flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-2.5 flex-shrink-0">
              <img src="/images/logo.png" alt={business.name} className="h-8 w-auto" />
            ...
            <>
              ...
              <div className="absolute top-full right-0 mt-2 bg-white rounded-2xl shadow-xl border border-stone-100 overflow-hidden z-50 min-w-52">
                ...
                <div className="border-t border-stone-100 px-5 py-3">
                  <a href={toTelHref(business.phone)} className="flex items-center gap-2 text-sm text-stone-600 hover:text-wood-600 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div className="md:col-span-1">
              <div className="mb-4">
                <img src="/images/logo.png" alt={business.name} className="h-10 w-auto brightness-0 invert" />
              </div>
              ...
              <div className="space-y-3 text-sm">
                {business.phone && (
                  <div className="flex items-start gap-2">
                    ...
                    <a href={toTelHref(business.phone)} className="hover:text-wood-400 transition-colors">
                      {business.phone}
                    </a>
                  </div>
                )}
                {business.email && (
                  <div className="flex items-start gap-2">
                    ...
                    <a href={`mailto:${business.email}`} className="hover:text-wood-400 transition-colors">
                      {business.email}
                    </a>
                  </div>
                )}
